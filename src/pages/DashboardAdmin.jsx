      ...
      <div className="w-64 bg-white shadow-lg">
        <div className="p-6">
          ...
          <nav className="space-y-2">
            ...
            <button
              className={`flex items-center space-x-3 px-4 py-3 rounded-lg font-medium w-full transition ${activeMenu === 'users' ? 'bg-purple-50 text-purple-600' : 'text-gray-700 hover:bg-gray-50'}`}
            ...
            <button
              className={`flex items-center space-x-3 px-4 py-3 rounded-lg font-medium w-full transition ${activeMenu === 'fees' ? 'bg-purple-50 text-purple-600' : 'text-gray-700 hover:bg-gray-50'}`}
